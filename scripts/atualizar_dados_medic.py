...
Se for para cotar: Abrir Emultec > Movimentos > Cirurgias > Cadastro > Clicar no ícone de papel (responsável pelo cadastramento de um novo) e preencher os dados com base no portal (preencher a aba parte do corpo).
