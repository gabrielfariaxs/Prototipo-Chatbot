...
export const TreinamentosModal: React.FC<TreinamentosModalProps> = ({ onClose, userLevel, userSector, userName }) => {
  ...
  const handleCreateSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setView('day_details')
      setFormData({ titulo: '', descricao: '', horario: '14:00', colaboradores: '', link_video: '' })
    } catch (e: any) {
      console.error(e)
          ...
          <form onSubmit={handleCreateSubmit} className="p-8 space-y-6">
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                  <label className="block text-[13px] font-black text-slate-700 uppercase tracking-widest mb-2">Horário Previsto</label>
                  <input 
