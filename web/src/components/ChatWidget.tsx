...
import { MessageCircle, X, Send, User, Bot, Layers, ArrowRight, FileText, Calculator, Briefcase, Paperclip, Shield, Clock, Zap, Lightbulb, ThumbsUp, ThumbsDown, Copy, Landmark, Activity, DollarSign, Mic, Volume2, VolumeX, BarChart2, MessageSquare, Trash2, FileSpreadsheet } from 'lucide-react'
