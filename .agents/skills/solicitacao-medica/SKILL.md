...
1. **≥3 marcas + ≥3 fornecedores por item** (Resolução CFM 2.318/2022 veda exclusividade). No campo/coluna de fornecedores, usar sempre o termo "sugeridos" ("Fornecedores Sugeridos"). **Consultar e basear-se obrigatoriamente no portfólio oficial de materiais e dispositivos da Medic Distribuidora e Arthromed** (ex: Âncoras FastFit/Sinfix, Botão Cortical Sinfix Button, Fio Surtufix UHMWPE, Betamix Gel, Broca Flexdrill, Cânulas Razek). Sugerir a **Medic Distribuidora** e a **Arthromed** entre os fornecedores recomendados.
